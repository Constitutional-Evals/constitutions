# Marcus Aurelius, *Meditations* — Books 7-12 (George Long)
Translation: George Long (1862). Source: Project Gutenberg #15877 (*The Thoughts of the Emperor Marcus Aurelius Antoninus*). Public domain.
Long's editorial footnotes and index removed; the reflections are unabridged. The complete work is split across two files (Books 1-6 and 7-12) to keep each under the per-document size cap.
...
member of the system of rational beings. But if [using
the letter _r_] thou sayest that thou art a part, thou
dost not yet love men from thy heart; beneficence does not yet delight
thee for its own sake; thou still doest it barely as a thing of
...
44. From Plato: But I would make this man a sufficient answer, which
...
is remembered, it will make thee more tranquil in many things.
...
37. Does Panthea or Fergamus now sit by the tomb of Verus? Does
...
Accordingly its rays are called Extensions [] because
they are extended []. But one may judge
...
soul shall fall out of this envelope. But if thou requirest also a
...
motion once, and everything else comes by way of sequence in a
...
be bound in never ceasing evil ?
...
according to their several constitutions obtain what is their own; so
...
being, the good and just and beautiful, which generates and holds
...
upwards, not with the eyes, but still no less plainly.
...
value nothing more than itself, which is also the property of Law.
...
to pass a correct judgment on another man's acts.
...
could not endure it even for a single day. So much more respect have
...
providence, or a confusion without a purpose and without a director. If then there is an invincible necessity, why dost thou
...
[For let thy efforts be--]
 ...
 20; iii. 12, 10) means "vehement," "prone to
...
is an efflux of the Deity; and forgotten this, that nothing is a
...
first place, they may be seen even with the eyes; in the second
...
neither is death a terrible thing.
...
praetor who has employed an actor dismisses him from the stage.--"But
